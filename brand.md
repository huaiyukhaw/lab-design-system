...
The single most recognizable trait, beyond palette and type, is the **warm canvas**:
the cream background carries a faint dot-grid and a soft clay glow at the top, fixed
behind all content. Combined with the clay text-selection tint and the soft, wide
shadows, it gives a quiet, paper-like, lab-notebook feel.
