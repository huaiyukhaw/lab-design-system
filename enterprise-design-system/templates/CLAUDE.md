...
`design-system/` (adjust the path below if you mounted it elsewhere). It is a cool, quiet,
editorial, **light-theme-only** system (modern blue/white enterprise palette).
...
- Cream canvas (`#f8fafc`) + a faint dot-grid + a soft blue glow at the top.
- **Clay (`#2563eb`) is the accent; ink (`#0b1220`) is the action surface** — the primary
